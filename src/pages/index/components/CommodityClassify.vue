...
// import { getGoodsCategoryListAPI, getGoodsListsAPI } from '@/services/home'
...
//   const result: any = await getGoodsCategoryListAPI({ page: 1, pageSize: 0 })
//   if (result.code === 200) {
//     if (result.data.list) {
//       for (let key in result.data.list) {
//         list1.value = result.data.list
//         list1.value[key] = {
//           ...list1,
//           name: result.data.list[key].categoryName,
//         }
//       }
//       goodsListquery.categoryName = list1.value[0].name
//       getGoodsListItems()
//     }
//   }
// }
//获取商品信息
// const getGoodsListItems = async () => {
//   const result: any = await getGoodsListsAPI(goodsListquery)
//   if (result.code === 200) {
