...
import { useCertification, useMemberStore, useOrderType, useOtherTypes } from '@/stores'
...
const orderTypes = [
  ...
  { state: 1, text: '未采样', icon: '/static/user/payment.png' },
...
const others = [
  ...
  { state: 7, text: '政府机关入口', icon: '/static/user/governmentEntrance.png' },
]
